...
namespace GrpcJsonTranscondingPerfTest.EnvoyClient
{
    public class Program
    {
        ...
        {
            private static readonly HttpClient _client = new HttpClient() { BaseAddress = new System.Uri("http://192.168.31.106:12317") };
